...
private:
  ...
  int  encode_pdcch_dl_fuzzer(stack_interface_phy_lte::dl_sched_grant_t* orin_grants, stack_interface_phy_lte::dl_sched_grant_t* fuzzer_grants, uint32_t nof_grants);
  int  encode_pdcch_ul_fuzzer(stack_interface_phy_lte::ul_sched_grant_t* grants, uint32_t nof_grants);
