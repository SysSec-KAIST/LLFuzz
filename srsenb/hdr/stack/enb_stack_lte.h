...
public:
  ...
  void start_fuzzer() override { mac.start_fuzzer();} //start sending test case
  ...
  void set_llfuzz_config_file(std::string llfuzz_config_file_){
    mac.set_llfuzz_config_file(llfuzz_config_file_);
  }
