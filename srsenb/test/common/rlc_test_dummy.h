...
class rlc_dummy : public rlc_interface_mac
{
  ...
  uint32_t get_sequence_number(uint16_t rnti, uint32_t lcid) override { return 0; }
  void mac_control_rlc_write_sdu(uint16_t rnti, uint32_t lcid, srsran::unique_byte_buffer_t sdu) override {}
};
