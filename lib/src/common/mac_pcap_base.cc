...
void mac_pcap_base::write_dl_crnti_ueid(uint8_t* pdu,
                                        uint32_t pdu_len_bytes,
                                        uint16_t crnti,
                                        bool     crc_ok,
                                        uint32_t tti,
                                        ...
                                        uint16_t ue_id_)
{
  pack_and_queue(pdu, pdu_len_bytes, ue_id_, 0, crc_ok, cc_idx, tti, crnti, DIRECTION_DOWNLINK, C_RNTI);
}
...
void mac_pcap_base::write_dl_ranti_ueid(uint8_t* pdu,
                                        uint32_t pdu_len_bytes,   
                                        uint16_t ranti,
                                        bool     crc_ok,
                                        uint32_t tti,
                                        ...
                                        uint16_t ue_id_)
{
  pack_and_queue(pdu, pdu_len_bytes, ue_id_, 0, crc_ok, cc_idx, tti, ranti, DIRECTION_DOWNLINK, RA_RNTI);
}
