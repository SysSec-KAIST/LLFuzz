...
#ifndef SRSRAN_RLC_UM_NR_H
#define SRSRAN_RLC_UM_NR_H
...
private:
  ...
  private:
    ...
    // TS 38.322 Sec. 7.3
    srsran::timer_handler::unique_timer reassembly_timer; // to detect loss of RLC PDUs at lower layers
