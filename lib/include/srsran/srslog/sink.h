...
public:
  ...
  // void set_llfuzz_config_file(const std::string& llfuzz_config_file_) { llfuzz_config_file = llfuzz_config_file_; }
  // std::string get_llfuzz_config_file() { return llfuzz_config_file; }

private:
  std::unique_ptr<log_formatter> formatter;
  // std::string                    llfuzz_config_file;
};
